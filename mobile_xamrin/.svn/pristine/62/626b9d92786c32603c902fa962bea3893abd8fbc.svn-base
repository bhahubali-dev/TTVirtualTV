...
{
	public class EventTableDataSource : UITableViewSource
	{
		//private IEventListService _IEventListService = null;
		private static List<EventList> _listItem = null;

		public EventTableDataSource(IEventListService IEventListService, List<EventList> firstPage)
		{
		...
		{
			var cell = tableView.DequeueReusableCell("EventViewCell", indexPath);
